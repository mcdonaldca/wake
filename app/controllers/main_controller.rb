...
=end
		user.fitbit_oauth_token = "c01853295fd81be232a2ae6c7b7f472e"
		user.fitbit_oauth_secret = "e0b0086b181864252e16fb6ff598101d"
		user.save()
		
		@url = "https://www.fitbit.com/oauth/authorize?oauth_token=" + user.fitbit_oauth_token
